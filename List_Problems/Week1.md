...
### 2. **Find the Duplicate Number** (Binary Search Approach)
   ...
   - **Explanation**:
     ...
     - 
     - In this case, mid =2 iterate whole array and update count `if num <=2 `, if count is lesser than 2 (mid) then there is a duplicate present in 3 or 4. so take the upper part of the series.
